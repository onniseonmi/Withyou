  ...
  return (
    <div>
      <div className='section1'>
        <div background-image>Moving images, gif</div>
        ...
        <div className='background-image'>
          ...
          <div>
            <div className='title'>
              세상에 없던 단 하나뿐인
              <br />
              청첩장, 쉬운 디자인과 생성을 도와드립니다.
            </div>
            <div className='subtitle2'>subtitle</div>
      ...
      <div className='section3'>
        ...
        <div className='section4'>
          ...
          <div className='subtitle4'>subtitle</div>
          <div className='content'>
            앞이 피에 우리 밥을 가치를 구하지 인간의 같은 말이다. 않는 생의 별과
            황금시대의 봄바람이다.
          </div>
          ...
          <div className='section5'>
            <div className='background-image'>
              ...
              <div>
                ...
                <div className='subtitle5'></div>
                <div className='content'>
                  앞이 피에 우리 밥을 가치를 구하지 인간의 같은 말이다. 않는
                  생의 별과 황금시대의 봄바람이다.
                </div>
